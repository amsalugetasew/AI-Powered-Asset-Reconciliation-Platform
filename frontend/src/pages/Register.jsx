      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="group relative w-full flex justify-center py-3 px-4 border
               border-transparent text-sm font-medium rounded-md text-white 
                bg-gradient-to-r from-[#8E288D] to-[#CFB53B] text-white rounded-lg hover:from-[#CFB53B] hover:to-[#8E288D] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50"
            >
          ...
          <div className="text-center">
            <Link to="/login" className="font-medium text-[#8E288D] hover:text-[#7A1E79]">
